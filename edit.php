...
<body>
    <?php 
        ...
        <form action="service/edit_service.php" method="get">
            <label>ID : </label> <input type="text" name="customer_id" value="<?php echo $data['cid'];?>" readonly> <br>
            <label>Name : </label> <input type="text" name="customer_name" value="<?php echo $data['cname'];?>"> <br>
            <label>Phone : </label> <input type="text" name="customer_phone" value="<?php echo $data['cphone'];?>"> <br>
            ...
            if ($conn = mysqli_query($global_link, $sql_salesman)) {
                foreach ($conn as $salesman) { ?>
                    <option value="<?php echo $salesman['sid']; ?>"><?php echo $salesman["sname"];?></option>
                    <?php
                    }
        ...
        <form action="service/edit_service.php" method="post">
            ...
            <input type="text" name="customer_id" value="<?php echo $data['cid'];?>" hidden readonly>
